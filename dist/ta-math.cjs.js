...
function ema(series, window, start = null) {
...
class TA {
  ...
  static bbp($close, window = 15, mult = 2)                                         { return bbp($close, window, mult) }
  static cci($high, $low, $close, window = 20, mult = 0.015)                        { return cci($high, $low, $close, window, mult) }
  static cho($high, $low, $close, $volume, winshort = 3, winlong = 10)              { return cho($high, $low, $close, $volume, winshort, winlong) }
  ...
  bbp(window = 15, mult = 2)                                            { return TA.bbp(this.$close, window, mult) }
