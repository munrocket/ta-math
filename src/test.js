...
describe('EBB', () => {
  ...
  let ebb = new TA([c,c,c,c,c,c], simpleFormat).ebb(14,2);
...
describe('PSAR', () => {
  ...
  let actual = new TA([c,c,c,c,c,c], simpleFormat).psar();
  it('Finite test', () => assert.ok(actual.every(isFinite)));
...
describe('Keltner channel', () => {
  ...
  let actual = new TA([h,h,h,l,c,c], simpleFormat).keltner(14,2);
...
describe('EXPDEV', () => {
  ...
  let actual = new TA([c,c,c,c,c,c], simpleFormat).expdev(14);
  it('Finite test', () => assert.ok(actual.every(isFinite)));
...
describe('MFI', () => {
  ...
  let actual = new TA([t,t,t,t,t,v], simpleFormat).mfi(14);
...
describe('Stoch', () => {
  ...
  let actual = new TA([h,h,h,l,c,c], simpleFormat).stoch(14,3,1);
...
describe('StochRsi', () => {
  ...
  let actual = new TA([c,c,c,c,c,c], simpleFormat).stochRsi(14,3,1);
  it('Finite test', () => assert.ok(actual.line.every(isFinite) && actual.signal.every(isFinite)));
...
describe('VI', () => {
  ...
  let actual = new TA([c,c,h,l,c,c], simpleFormat).vi(14);
...
describe('CCI', () => {
  ...
  let actual = new TA([h,h,h,l,c,c], simpleFormat).cci(20,0.015);
  it('Finite test', () => assert.ok(actual.every(isFinite)));
  let delta = nrmse(expected.slice(20), actual.slice(20));
  it(`NRMSE test (${delta.toFixed(5)})`, () => assert.ok(delta < 1e-2));
})
...
describe('OBV', () => {
  ...
  let actual = new TA([c,c,c,c,c,v], simpleFormat).obv(10);
...
describe('ATR', () => {
  ...
  let actual = new TA([c,c,h,l,c,c], simpleFormat).atr(14);
...
describe('Williams', () => {
  ...
  let actual = new TA([h,h,h,l,c,c], simpleFormat).williams(14);
